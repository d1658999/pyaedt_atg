...
- Set the **Expansion Factor / Size** (default is **0.1** representing the `expansion_factor` for a `Conforming` cutout, or physical millimeters, e.g., **2.0** mm, for `ConvexHull` or `Bounding`).
